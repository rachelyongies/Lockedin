...
export const NETWORKS = {
  mainnet: {
    ...
    rpcUrl: process.env.NEXT_PUBLIC_MAINNET_RPC_URL || "https://eth-mainnet.g.alchemy.com/v2/ALCHEMY_API",
  ...
  sepolia: {
    ...
    rpcUrl: process.env.NEXT_PUBLIC_ETH_RPC_URL || "https://eth-sepolia.g.alchemy.com/v2/ALCHEMY_API",
  ...
  polygon: {
    ...
    rpcUrl: process.env.NEXT_PUBLIC_POLYGON_RPC_URL || "https://polygon-mainnet.g.alchemy.com/v2/ALCHEMY_API",
  ...
  arbitrum: {
    chainId: 42161,
    name: "Arbitrum One",
    rpcUrl: process.env.NEXT_PUBLIC_ARBITRUM_RPC_URL || "https://arb-mainnet.g.alchemy.com/v2/ALCHEMY_API",
  ...
  optimism: {
    chainId: 10,
    name: "Optimism",
    rpcUrl: process.env.NEXT_PUBLIC_OPTIMISM_RPC_URL || "https://opt-mainnet.g.alchemy.com/v2/ALCHEMY_API",
