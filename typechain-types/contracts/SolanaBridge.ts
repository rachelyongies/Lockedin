...
export interface SolanaBridgeInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "initiateFromSolana",
    values: [BytesLike, AddressLike, BigNumberish, BytesLike, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "initiateToSolana",
  ...
  encodeFunctionData(functionFragment: "wsolToken", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "wsolToken", data: BytesLike): Result;
}
...
export interface SolanaBridge extends BaseContract {
  ...
  initiateFromSolana: TypedContractMethod<
    [
      id: BytesLike,
  ...
  initiateToSolana: TypedContractMethod<
    [
      id: BytesLike,
  ...
  wsolToken: TypedContractMethod<[], [string], "view">;
  ...
  >;
  getFunction(
    nameOrSignature: "initiateFromSolana"
  ): TypedContractMethod<
    [
      id: BytesLike,
      _ethereumAddress: AddressLike,
  ...
  >;
  getFunction(
    nameOrSignature: "initiateToSolana"
  ): TypedContractMethod<
    [
      id: BytesLike,
      _solanaAddress: string,
